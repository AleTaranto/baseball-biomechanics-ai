...
- Skeleton wireframe overlays, anatomical skeleton scaling, stabilized 2D bat tracking overlays with motion trails, arm slot rays, stride baselines, and HUD phase badges burned into video files.
